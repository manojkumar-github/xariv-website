  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      <div className="rounded-xl border border-line bg-surface p-6 shadow-sm">
        <p className="eyebrow">Today — fragmented</p>
      ...
      <div className="rounded-xl border border-accent/20 bg-gradient-to-br from-accent-muted/40 to-surface p-6 shadow-sm">
        <p className="eyebrow text-accent">With XARIV — one platform</p>
